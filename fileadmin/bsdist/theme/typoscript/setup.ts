...
page {
  ...
  10 {
    ...
    file.cObject {
      ...
      5 = TEXT
      5.value       = {$plugin.tx_bootstrapcore.theme.baseDir}/tmpl/backend_layout/tmpl_conrad_main.html
    }
    ...
    variables {
      ...
      content_topcontent < styles.content.get
      content_topcontent.select.where = colPos=3
    }
  }
  ...
  includeCSS {
    ...
    codebros = {$plugin.tx_bootstrapcore.theme.baseDir}/css/codebros.css
  }
  includeJSlibs {
...
lib {
  ...
  logo {
    10 = TEXT
    10.value = <img src="{$plugin.tx_bootstrapcore.theme.baseDir}/img/logo.jpg" class="logo img-responsive" />
